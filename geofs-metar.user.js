...
(function () {
  ...
  "VQPR": { name: "Paro Airport (Bhutan)", lat: 27.4032, lon: 89.4246 },
  "TFFJ": { name: "Gustaf III Airport (St. Barts)", lat: 17.9044, lon: -62.8439 },
  "TVSV": { name: "Argyle International Airport (St. Vincent)", lat: 13.1567, lon: -61.1499 },
  "LXGB": { name: "Gibraltar Airport", lat: 36.1512, lon: -5.3497 },
  "LPMA": { name: "Cristiano Ronaldo Madeira Airport", lat: 32.6979, lon: -16.7745 },
  "NZWN": { name: "Wellington Intl", lat: -41.3272, lon: 174.8056 },
  "WADD": { name: "Ngurah Rai Intl (Bali) [短但繁忙]", lat: -8.7482, lon: 115.1675 },
  "NTTB": { name: "Bora Bora Airport", lat: -16.4444, lon: -151.7519 },
  "SEGS": { name: "San Cristobal Airport (Galapagos)", lat: -0.9102, lon: -89.6174 },
  "SKPS": { name: "Antonio Nariño Airport (Pasto)", lat: 1.3962, lon: -77.2915 },
  "MGGT": { name: "La Aurora Intl (Guatemala City)", lat: 14.5833, lon: -90.5275 },
  "MHRO": { name: "Roatán Island Airport (Honduras)", lat: 16.3168, lon: -86.5230 },
  "PACO": { name: "Contadora Airport (Panama)", lat: 8.6275, lon: -79.0356 },
  "VNKT": { name: "Tribhuvan Intl (Kathmandu)", lat: 27.6966, lon: 85.3591 },
  "FJDG": { name: "Diego Garcia Naval Support Facility", lat: -7.3133, lon: 72.4111 },
  "AGGH": { name: "Honiara Intl (Solomon Islands)", lat: -9.4280, lon: 160.0549 },
  "YBRM": { name: "Broome Intl (Australia)", lat: -17.9447, lon: 122.2326 },
  "NSAS": { name: "Asau Airport (Samoa)", lat: -13.5167, lon: -172.6333 },
  ...
  "RCTP": { name: "Taipei Taoyuan Intl", lat: 25.0777, lon: 121.2330 },
  "RCSS": { name: "Taipei Songshan", lat: 25.0694, lon: 121.5525 },
  "RCKH": { name: "Kaohsiung Intl", lat: 22.5771, lon: 120.3500 },
  "RCMQ": { name: "Taichung Intl (Ching Chuan Kang)", lat: 24.2647, lon: 120.6200 },
  "RCYU": { name: "Hualien Airport", lat: 24.0231, lon: 121.6170 },
  "RCNN": { name: "Tainan Airport", lat: 22.9504, lon: 120.2060 },
  "RCDC": { name: "Chiayi Airport", lat: 23.4611, lon: 120.3920 },
  "RCQS": { name: "Kinmen Shang Yi Airport", lat: 24.4279, lon: 118.3590 },
  "RCQC": { name: "Magong Airport (Penghu)", lat: 23.5687, lon: 119.6283 },
  "RCGI": { name: "Green Island Airport", lat: 22.6739, lon: 121.4660 },
  "RCUK": { name: "Hengchun Airport", lat: 22.0411, lon: 120.7308 },
  "RCLY": { name: "Lanyu Airport (Orchid Island)", lat: 22.0270, lon: 121.5358 },
  "RCFS": { name: "Fengnin Airport (Taitung)", lat: 22.7583, lon: 121.1017 },
  "RCMT": { name: "Matsu Beigan Airport", lat: 26.2244, lon: 119.9800 },
  "RCFG": { name: "Matsu Nangan Airport", lat: 26.1590, lon: 119.9510 },
  "RCWA": { name: "Wang-an Airport (Penghu)", lat: 23.3674, lon: 119.5022 },
  "RCSP": { name: "Pingtung Airport", lat: 22.6739, lon: 120.4611 },
  "RCFG": { name: "Nangan Airport (Matsu)", lat: 26.1590, lon: 119.9510 },
  "RCNO": { name: "Taoyuan North Heliport", lat: 25.0950, lon: 121.2440 },
  "RCCM": { name: "Chengkung Airport", lat: 23.1000, lon: 121.3650 },
  "RCQS": { name: "Kinmen Airport", lat: 24.4279, lon: 118.3590 },
  "RCQX": { name: "Cimei Airport (Qimei Island)", lat: 23.2131, lon: 119.4181 },
  "RCWM": { name: "Wang-an Airstrip", lat: 23.3674, lon: 119.5022 },
  "RCZU": { name: "Zuoying Naval Airfield (legacy)", lat: 22.6861, lon: 120.2847 },
 ...
 "RCSS": { name: "Taipei Songshan Airport", lat: 25.0694, lon: 121.5525 },
  ...
  "TVSV": "America/St_Vincent",
  "LXGB": "Europe/Gibraltar",
  "LPMA": "Atlantic/Madeira",
  "NZWN": "Pacific/Auckland",
  "WADD": "Asia/Makassar",
  "NTTB": "Pacific/Tahiti",
  ...
  "VNKT": "Asia/Kathmandu",
  "FJDG": "Indian/Chagos",
  "AGGH": "Pacific/Guadalcanal",
  "YBRM": "Australia/Perth",
  "NSAS": "Pacific/Apia",
  "WIDD": "Asia/Jakarta",
  "WIMM": "Asia/Jakarta",
  "WIII": "Asia/Jakarta",
