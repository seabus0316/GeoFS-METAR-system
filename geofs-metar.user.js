...
(function () {
  ...
  "EGTE": { name: "Exeter Airport", lat: 50.7344, lon: -3.4139 },
  "EGNS": { name: "Isle of Man Airport", lat: 54.0833, lon: -4.6239 },
  "EGHD": { name: "Plymouth City Airport", lat: 50.4228, lon: -4.1058 },
  "EGPE": { name: "Inverness Airport", lat: 57.5425, lon: -4.0475 },
  "EGLF": { name: "Farnborough Airport", lat: 51.2758, lon: -0.7763 },
  "EGSH": { name: "Norwich Airport", lat: 52.6758, lon: 1.2828 },
  "EGBB": { name: "Birmingham Airport", lat: 52.4539, lon: -1.7480 },
  "EGNM": { name: "Leeds Bradford Intl", lat: 53.8659, lon: -1.6606 },
  "EIKY": { name: "Kerry Airport", lat: 52.1809, lon: -9.5238 },
  "EICK": { name: "Cork Airport", lat: 51.8413, lon: -8.4911 },
  "EINN": { name: "Shannon Airport", lat: 52.7019, lon: -8.9248 },
  "ELLX": { name: "Luxembourg Airport", lat: 49.6266, lon: 6.2115 },
  "LIML": { name: "Milan Linate", lat: 45.4451, lon: 9.2767 },
  "LIBD": { name: "Bari Karol Wojtyla Airport", lat: 41.1389, lon: 16.7606 },
  "LIEO": { name: "Olbia Costa Smeralda Airport", lat: 40.8987, lon: 9.5176 },
  "LICJ": { name: "Palermo Airport", lat: 38.1759, lon: 13.0910 },
  "LIRQ": { name: "Florence Airport", lat: 43.8100, lon: 11.2051 },
  "LIPX": { name: "Verona Villafranca", lat: 45.3957, lon: 10.8885 },
  "LFBZ": { name: "Biarritz Pays Basque", lat: 43.4684, lon: -1.5310 },
  "LFMT": { name: "Montpellier–Méditerranée", lat: 43.5762, lon: 3.9630 },
  "LFLY": { name: "Lyon–Bron Airport", lat: 45.7272, lon: 4.9443 },
  "LFQQ": { name: "Lille Airport", lat: 50.5633, lon: 3.0890 },
  "LFST": { name: "Strasbourg Airport", lat: 48.5383, lon: 7.6282 },
  "LFSB": { name: "Basel-Mulhouse EuroAirport", lat: 47.59, lon: 7.5292 },
  "LFMG": { name: "Castres–Mazamet Airport", lat: 43.5564, lon: 2.2892 },
  "EDLW": { name: "Dortmund Airport", lat: 51.5183, lon: 7.6122 },
  "EDFH": { name: "Frankfurt-Hahn Airport", lat: 49.9487, lon: 7.2639 },
  "EDDS": { name: "Stuttgart Airport", lat: 48.6899, lon: 9.2219 },
  "EDNY": { name: "Friedrichshafen Airport", lat: 47.6713, lon: 9.5115 },
  "EDMQ": { name: "Ingolstadt-Manching Airport", lat: 48.7157, lon: 11.5340 },
  "EDDM": { name: "Memmingen Airport", lat: 47.9888, lon: 10.2395 },
  "EDDK": { name: "Cologne Bonn Airport", lat: 50.8659, lon: 7.1427 },
  "EDDL": { name: "Niederrhein (Weeze) Airport", lat: 51.6024, lon: 6.1422 },
  "EKBI": { name: "Billund Airport", lat: 55.7403, lon: 9.1518 },
  "EKYT": { name: "Aalborg Airport", lat: 57.0928, lon: 9.8492 },
  "ESGG": { name: "Gothenburg Landvetter", lat: 57.6628, lon: 12.2798 },
  "ESMS": { name: "Malmö Airport", lat: 55.5363, lon: 13.3762 },
  "ESSL": { name: "Linköping Airport", lat: 58.4061, lon: 15.6805 },
  "EFRO": { name: "Rovaniemi Airport", lat: 66.5648, lon: 25.8304 },
  "EFET": { name: "Enontekiö Airport", lat: 68.3626, lon: 23.4243 },
  "EVRA": { name: "Riga Intl", lat: 56.9236, lon: 23.9711 },
  "EYVI": { name: "Vilnius Intl", lat: 54.6341, lon: 25.2858 },
  "EVLA": { name: "Liepāja Intl", lat: 56.5175, lon: 21.0969 },
  "EPWR": { name: "Wrocław–Copernicus Airport", lat: 51.1027, lon: 16.8858 },
  "EPGD": { name: "Gdańsk Lech Wałęsa Airport", lat: 54.3776, lon: 18.4662 },
  "EPKK": { name: "John Paul II Kraków-Balice Airport", lat: 50.0777, lon: 19.7848 },
  "EPPO": { name: "Poznań–Ławica Airport", lat: 52.4210, lon: 16.8263 },
  "EPKT": { name: "Katowice Airport", lat: 50.4743, lon: 19.0800 },
  "EPRA": { name: "Radom Airport", lat: 51.3892, lon: 21.2133 },
  "LDSP": { name: "Split Airport", lat: 43.5389, lon: 16.2981 },
  "VIJP": { name: "Jaipur International Airport", lat: 26.8242, lon: 75.8122 },
  "RCSS": { name: "Taipei Songshan Airport", lat: 25.0694, lon: 121.5525 },
  "KRNO": { name: "Reno/Tahoe Intl Airport", lat: 39.4991, lon: -119.7681 },
  "RCTP": { name: "Taipei Taoyuan International Airport", lat: 25.0777, lon: 121.2330 },
  "RCSS": { name: "Taipei Songshan Airport", lat: 25.0694, lon: 121.5525 },
  "RCKH": { name: "Kaohsiung International Airport", lat: 22.5771, lon: 120.3500 },
  "RCNN": { name: "Tainan Airport", lat: 22.9504, lon: 120.2060 },
  "RCMQ": { name: "Taichung International Airport (Ching Chuan Kang)", lat: 24.2647, lon: 120.6210 },
  "RCYU": { name: "Hualien Airport", lat: 24.0231, lon: 121.6175 },
  "RCDC": { name: "Chiayi Airport", lat: 23.4611, lon: 120.3897 },
  "RCFG": { name: "Green Island Airport", lat: 22.6739, lon: 121.4660 },
  "RCGI": { name: "Cimei Airport", lat: 23.2131, lon: 119.4176 },
  "RCLG": { name: "Lanyu Airport", lat: 22.0450, lon: 121.5358 },
  "RCQC": { name: "Kinmen Airport", lat: 24.4279, lon: 118.3594 },
  "RCBS": { name: "Matsu Beigan Airport", lat: 26.2242, lon: 120.0020 },
  "RCMT": { name: "Matsu Nangan Airport", lat: 26.1598, lon: 119.9583 },
  "RCFN": { name: "Pingtung Airport", lat: 22.7560, lon: 120.4310 },
  "RCWA": { name: "Wan-An Airport", lat: 23.3667, lon: 119.5022 },
  "RCUK": { name: "Hengchun Airport", lat: 22.0411, lon: 120.7308 },
  "RCFS": { name: "Shang-Yi Airport (Magong)", lat: 23.5687, lon: 119.6276 },
